    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sensorManager.registerListener(GyroscopeActivity.this, sensor,sensorManager.SENSOR_DELAY_NORMAL);
            }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sensorManager.flush(GyroscopeActivity.this);
                sensorManager.unregisterListener(GyroscopeActivity.this);
            }
        });
    }
